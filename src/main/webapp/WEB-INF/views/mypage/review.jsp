...
<section style="padding: 200px 0; width:1200px; margin:0 auto;">
	...
	<form action="/mypage/reviewinsert" class="mb-3" name="myform" id="myform" method="post" enctype="multipart/form-data">
		<fieldset>
		...
		<div class="pull-right" style="width:220px;height:80px; padding:30px 0">
