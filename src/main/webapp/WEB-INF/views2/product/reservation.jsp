		...
		<div class="row">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<h3>예약자 이름</h3>
								<input class="form-control valid" name="cname" id="cname"
									type="text" placeholder="체크인시 필요한 정보입니다."> <br>
								<h3>예약자 전화번호</h3>
								<input class="form-control valid" name="cphone" id="cphone"
									type="text" placeholder="체크인시 필요한 정보입니다."> <br>
			...
			<div class="col-lg-3 offset-lg-1">
				...
				<div class="media contact-info">
					<div class="media-body">
						<h3>객실타입/기간</h3>
						<p>${bookingInfo.rname}호/<span id="days">1</span>박
						</p>
					</div>
				</div>
				<div class="media contact-info">
